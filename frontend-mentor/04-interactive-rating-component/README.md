...
| Difficulty | Newbie |
| Access | Free |
| Challenge brief | https://www.frontendmentor.io/challenges/interactive-rating-component-koxpeBUmI |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/04-interactive-rating-component/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/04-interactive-rating-component

npm create vite@latest frontend-mentor/04-interactive-rating-component -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/04-interactive-rating-component/README.md

npm pkg set name="@react-challenges/04-interactive-rating-component" --workspace frontend-mentor/04-interactive-rating-component
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/04-interactive-rating-component
```
