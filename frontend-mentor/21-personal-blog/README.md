...
| Access | Premium |
| Challenge brief | https://www.frontendmentor.io/challenges/personal-blog-lJpVCnmozL |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/21-personal-blog/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/21-personal-blog

npm create vite@latest frontend-mentor/21-personal-blog -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/21-personal-blog/README.md

npm pkg set name="@react-challenges/21-personal-blog" --workspace frontend-mentor/21-personal-blog
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/21-personal-blog
```
