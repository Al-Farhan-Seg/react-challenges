...
| Difficulty | Newbie |
| Access | Free |
| Challenge brief | https://www.frontendmentor.io/challenges/faq-accordion-wyfFdeBwBz |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/03-faq-accordion/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/03-faq-accordion

npm create vite@latest frontend-mentor/03-faq-accordion -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/03-faq-accordion/README.md

npm pkg set name="@react-challenges/03-faq-accordion" --workspace frontend-mentor/03-faq-accordion
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/03-faq-accordion
```
