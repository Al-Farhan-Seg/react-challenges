...
```bash
mv frontend-mentor/06-contact-form/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/06-contact-form

npm create vite@latest frontend-mentor/06-contact-form -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/06-contact-form/README.md

npm pkg set name="@react-challenges/06-contact-form" --workspace frontend-mentor/06-contact-form
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/06-contact-form
```
