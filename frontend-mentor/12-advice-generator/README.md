...
| Difficulty | Junior |
| Access | Free |
| Challenge brief | https://www.frontendmentor.io/challenges/advice-generator-app-QdUG-13db |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/12-advice-generator/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/12-advice-generator

npm create vite@latest frontend-mentor/12-advice-generator -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/12-advice-generator/README.md

npm pkg set name="@react-challenges/12-advice-generator" --workspace frontend-mentor/12-advice-generator
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/12-advice-generator
```
