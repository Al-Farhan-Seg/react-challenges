...
| Difficulty | Advanced |
| Access | Premium |
| Challenge brief | https://www.frontendmentor.io/challenges/devjobs-web-app-HuvC_LP4l |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/23-devjobs-web-app/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/23-devjobs-web-app

npm create vite@latest frontend-mentor/23-devjobs-web-app -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/23-devjobs-web-app/README.md

npm pkg set name="@react-challenges/23-devjobs-web-app" --workspace frontend-mentor/23-devjobs-web-app
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/23-devjobs-web-app
```
