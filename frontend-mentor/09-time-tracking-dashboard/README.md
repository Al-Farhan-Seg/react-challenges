...
| Difficulty | Junior |
| Access | Free |
| Challenge brief | https://www.frontendmentor.io/challenges/time-tracking-dashboard-UIQ7167Jw |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/09-time-tracking-dashboard/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/09-time-tracking-dashboard

npm create vite@latest frontend-mentor/09-time-tracking-dashboard -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/09-time-tracking-dashboard/README.md

npm pkg set name="@react-challenges/09-time-tracking-dashboard" --workspace frontend-mentor/09-time-tracking-dashboard
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/09-time-tracking-dashboard
```
