...
| Difficulty | Advanced |
| Access | Free |
| Challenge brief | https://www.frontendmentor.io/challenges/multistep-form-YVAnSdqQBJ |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/25-multi-step-form/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/25-multi-step-form

npm create vite@latest frontend-mentor/25-multi-step-form -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/25-multi-step-form/README.md

npm pkg set name="@react-challenges/25-multi-step-form" --workspace frontend-mentor/25-multi-step-form
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/25-multi-step-form
```
