...
| Difficulty | Junior |
| Access | Free |
| Challenge brief | https://www.frontendmentor.io/challenges/expenses-chart-component-e7yJBUdjwt |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/05-expenses-chart-component/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/05-expenses-chart-component

npm create vite@latest frontend-mentor/05-expenses-chart-component -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/05-expenses-chart-component/README.md

npm pkg set name="@react-challenges/05-expenses-chart-component" --workspace frontend-mentor/05-expenses-chart-component
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/05-expenses-chart-component
```
