...
| Access | Premium |
| Challenge brief | https://www.frontendmentor.io/challenges/frontend-quiz-app-BE7xkzXQnU |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/22-frontend-quiz/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/22-frontend-quiz

npm create vite@latest frontend-mentor/22-frontend-quiz -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/22-frontend-quiz/README.md

npm pkg set name="@react-challenges/22-frontend-quiz" --workspace frontend-mentor/22-frontend-quiz
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/22-frontend-quiz
```
