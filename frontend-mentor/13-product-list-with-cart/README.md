...
| Difficulty | Junior |
| Access | Free |
| Challenge brief | https://www.frontendmentor.io/challenges/product-list-with-cart-5MmqLVAp_d |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/13-product-list-with-cart/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/13-product-list-with-cart

npm create vite@latest frontend-mentor/13-product-list-with-cart -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/13-product-list-with-cart/README.md

npm pkg set name="@react-challenges/13-product-list-with-cart" --workspace frontend-mentor/13-product-list-with-cart
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/13-product-list-with-cart
```
