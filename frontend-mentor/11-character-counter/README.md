...
| Difficulty | Junior |
| Access | Premium |
| Challenge brief | https://www.frontendmentor.io/challenges/character-counter-znSgeWs_i6 |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/11-character-counter/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/11-character-counter

npm create vite@latest frontend-mentor/11-character-counter -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/11-character-counter/README.md

npm pkg set name="@react-challenges/11-character-counter" --workspace frontend-mentor/11-character-counter
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/11-character-counter
```
