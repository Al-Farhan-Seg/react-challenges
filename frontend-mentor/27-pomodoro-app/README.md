...
| Difficulty | Advanced |
| Access | Premium |
| Challenge brief | https://www.frontendmentor.io/challenges/pomodoro-app-KBFnycJ6G |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/27-pomodoro-app/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/27-pomodoro-app

npm create vite@latest frontend-mentor/27-pomodoro-app -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/27-pomodoro-app/README.md

npm pkg set name="@react-challenges/27-pomodoro-app" --workspace frontend-mentor/27-pomodoro-app
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/27-pomodoro-app
```
