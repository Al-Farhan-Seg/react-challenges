...
| Access | Free |
| Challenge brief | https://www.frontendmentor.io/challenges/calculator-app-9lteq5N29 |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/19-calculator-app/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/19-calculator-app

npm create vite@latest frontend-mentor/19-calculator-app -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/19-calculator-app/README.md

npm pkg set name="@react-challenges/19-calculator-app" --workspace frontend-mentor/19-calculator-app
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/19-calculator-app
```
