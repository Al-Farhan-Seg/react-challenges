# 07 - Newsletter sign-up form with success message
...
| Difficulty | Junior |
| Access | Free |
| Challenge brief | https://www.frontendmentor.io/challenges/newsletter-signup-form-with-success-message-3FC1AZbNrv |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/07-newsletter-signup-form/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/07-newsletter-signup-form

npm create vite@latest frontend-mentor/07-newsletter-signup-form -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/07-newsletter-signup-form/README.md

npm pkg set name="@react-challenges/07-newsletter-signup-form" --workspace frontend-mentor/07-newsletter-signup-form
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/07-newsletter-signup-form
```
