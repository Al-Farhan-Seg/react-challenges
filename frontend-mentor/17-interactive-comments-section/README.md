# 17 - Interactive comments section
...
| Access | Free |
| Challenge brief | https://www.frontendmentor.io/challenges/interactive-comments-section-iG1RugEG9 |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/17-interactive-comments-section/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/17-interactive-comments-section

npm create vite@latest frontend-mentor/17-interactive-comments-section -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/17-interactive-comments-section/README.md

npm pkg set name="@react-challenges/17-interactive-comments-section" --workspace frontend-mentor/17-interactive-comments-section
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/17-interactive-comments-section
```
