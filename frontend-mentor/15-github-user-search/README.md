...
| Difficulty | Junior |
| Access | Premium |
| Challenge brief | https://www.frontendmentor.io/challenges/github-user-search-app-Q09YOgaH6 |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/15-github-user-search/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/15-github-user-search

npm create vite@latest frontend-mentor/15-github-user-search -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/15-github-user-search/README.md

npm pkg set name="@react-challenges/15-github-user-search" --workspace frontend-mentor/15-github-user-search
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/15-github-user-search
```
