# 14 - Conference ticket generator
...
| Difficulty | Junior |
| Access | Free |
| Challenge brief | https://www.frontendmentor.io/challenges/conference-ticket-generator-oq5gFIU12w |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/14-conference-ticket-generator/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/14-conference-ticket-generator

npm create vite@latest frontend-mentor/14-conference-ticket-generator -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/14-conference-ticket-generator/README.md

npm pkg set name="@react-challenges/14-conference-ticket-generator" --workspace frontend-mentor/14-conference-ticket-generator
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/14-conference-ticket-generator
```
