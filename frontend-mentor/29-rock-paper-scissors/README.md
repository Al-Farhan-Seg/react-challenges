...
```bash
mv frontend-mentor/29-rock-paper-scissors/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/29-rock-paper-scissors

npm create vite@latest frontend-mentor/29-rock-paper-scissors -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/29-rock-paper-scissors/README.md

npm pkg set name="@react-challenges/29-rock-paper-scissors" --workspace frontend-mentor/29-rock-paper-scissors
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/29-rock-paper-scissors
```
