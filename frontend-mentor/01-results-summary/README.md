...
| Difficulty | Newbie |
| Access | Free |
| Challenge brief | https://www.frontendmentor.io/challenges/results-summary-component-CE_K6s0maV |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/01-results-summary/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/01-results-summary

npm create vite@latest frontend-mentor/01-results-summary -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/01-results-summary/README.md

npm pkg set name="@react-challenges/01-results-summary" --workspace frontend-mentor/01-results-summary
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/01-results-summary
```
