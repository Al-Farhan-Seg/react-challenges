...
| Difficulty | Advanced |
| Access | Premium |
| Challenge brief | https://www.frontendmentor.io/challenges/connect-four-game-6G8QVH923s |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/32-connect-four/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/32-connect-four

npm create vite@latest frontend-mentor/32-connect-four -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/32-connect-four/README.md

npm pkg set name="@react-challenges/32-connect-four" --workspace frontend-mentor/32-connect-four
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/32-connect-four
```
