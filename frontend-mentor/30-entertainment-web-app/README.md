...
| Difficulty | Advanced |
| Access | Premium |
| Challenge brief | https://www.frontendmentor.io/challenges/entertainment-web-app-J-UhgAW1X |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/30-entertainment-web-app/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/30-entertainment-web-app

npm create vite@latest frontend-mentor/30-entertainment-web-app -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/30-entertainment-web-app/README.md

npm pkg set name="@react-challenges/30-entertainment-web-app" --workspace frontend-mentor/30-entertainment-web-app
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/30-entertainment-web-app
```
