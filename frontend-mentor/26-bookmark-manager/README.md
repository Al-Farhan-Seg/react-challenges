...
| Difficulty | Advanced |
| Access | Premium |
| Challenge brief | https://www.frontendmentor.io/challenges/bookmark-manager-app |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/26-bookmark-manager/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/26-bookmark-manager

npm create vite@latest frontend-mentor/26-bookmark-manager -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/26-bookmark-manager/README.md

npm pkg set name="@react-challenges/26-bookmark-manager" --workspace frontend-mentor/26-bookmark-manager
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/26-bookmark-manager
```
