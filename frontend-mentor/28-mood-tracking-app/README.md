...
| Difficulty | Advanced |
| Access | Premium |
| Challenge brief | https://www.frontendmentor.io/challenges/mood-tracking-app-E2XeKhDF0B |
| Status | **Not Started** |
...
```bash
mv frontend-mentor/28-mood-tracking-app/README.md /tmp/challenge-readme.md
rm -rf frontend-mentor/28-mood-tracking-app

npm create vite@latest frontend-mentor/28-mood-tracking-app -- --template react --no-immediate
mv /tmp/challenge-readme.md frontend-mentor/28-mood-tracking-app/README.md

npm pkg set name="@react-challenges/28-mood-tracking-app" --workspace frontend-mentor/28-mood-tracking-app
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/28-mood-tracking-app
```
