# 08 - AI Chatbot - simplechat.ai

| | |
| --- | --- |
| Source | [devChallenges](https://devchallenges.io/challenges-dashboard?path=%2C3) |
| Difficulty | Mid-level |
| Challenge brief | https://devchallenges.io/challenge/ai-chat-bot |
| Status | **Not Started** |
...
```bash
mv dev-challenges/08-ai-chatbot-simplechat/README.md /tmp/challenge-readme.md
rm -rf dev-challenges/08-ai-chatbot-simplechat

npm create vite@latest dev-challenges/08-ai-chatbot-simplechat -- --template react --no-immediate
mv /tmp/challenge-readme.md dev-challenges/08-ai-chatbot-simplechat/README.md

npm pkg set name="@react-challenges/08-ai-chatbot-simplechat" --workspace dev-challenges/08-ai-chatbot-simplechat
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/08-ai-chatbot-simplechat
```
