...
| Challenge brief | https://devchallenges.io/challenge/task-manager-app |
| Status | **Not Started** |
...
```bash
mv dev-challenges/10-task-manager-app/README.md /tmp/challenge-readme.md
rm -rf dev-challenges/10-task-manager-app

npm create vite@latest dev-challenges/10-task-manager-app -- --template react --no-immediate
mv /tmp/challenge-readme.md dev-challenges/10-task-manager-app/README.md

npm pkg set name="@react-challenges/10-task-manager-app" --workspace dev-challenges/10-task-manager-app
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/10-task-manager-app
```
