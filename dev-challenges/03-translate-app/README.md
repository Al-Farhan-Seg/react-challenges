...
| Challenge brief | https://devchallenges.io/challenge/translate-app |
| Status | **Not Started** |
...
```bash
mv dev-challenges/03-translate-app/README.md /tmp/challenge-readme.md
rm -rf dev-challenges/03-translate-app

npm create vite@latest dev-challenges/03-translate-app -- --template react --no-immediate
mv /tmp/challenge-readme.md dev-challenges/03-translate-app/README.md

npm pkg set name="@react-challenges/03-translate-app" --workspace dev-challenges/03-translate-app
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/03-translate-app
```
