...
| Challenge brief | https://devchallenges.io/challenge/property-listing |
| Status | **Not Started** |
...
```bash
mv dev-challenges/02-property-listing/README.md /tmp/challenge-readme.md
rm -rf dev-challenges/02-property-listing

npm create vite@latest dev-challenges/02-property-listing -- --template react --no-immediate
mv /tmp/challenge-readme.md dev-challenges/02-property-listing/README.md

npm pkg set name="@react-challenges/02-property-listing" --workspace dev-challenges/02-property-listing
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/02-property-listing
```
