...
| Challenge brief | https://devchallenges.io/challenge/country-quizz |
| Status | **Not Started** |
...
```bash
mv dev-challenges/06-country-quiz/README.md /tmp/challenge-readme.md
rm -rf dev-challenges/06-country-quiz

npm create vite@latest dev-challenges/06-country-quiz -- --template react --no-immediate
mv /tmp/challenge-readme.md dev-challenges/06-country-quiz/README.md

npm pkg set name="@react-challenges/06-country-quiz" --workspace dev-challenges/06-country-quiz
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/06-country-quiz
```
