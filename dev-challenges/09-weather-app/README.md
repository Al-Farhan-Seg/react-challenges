...
| Challenge brief | https://devchallenges.io/challenge/weather-app |
| Status | **Not Started** |
...
```bash
mv dev-challenges/09-weather-app/README.md /tmp/challenge-readme.md
rm -rf dev-challenges/09-weather-app

npm create vite@latest dev-challenges/09-weather-app -- --template react --no-immediate
mv /tmp/challenge-readme.md dev-challenges/09-weather-app/README.md

npm pkg set name="@react-challenges/09-weather-app" --workspace dev-challenges/09-weather-app
npm install
