# 04 - Recipe page - HomeChef

| | |
| --- | --- |
| Source | [devChallenges](https://devchallenges.io/challenges-dashboard?path=%2C3) |
| Difficulty | Mid-level |
| Challenge brief | https://devchallenges.io/challenge/recipe-page-homechef |
| Status | **Not Started** |
...
```bash
mv dev-challenges/04-recipe-page-homechef/README.md /tmp/challenge-readme.md
rm -rf dev-challenges/04-recipe-page-homechef

npm create vite@latest dev-challenges/04-recipe-page-homechef -- --template react --no-immediate
mv /tmp/challenge-readme.md dev-challenges/04-recipe-page-homechef/README.md

npm pkg set name="@react-challenges/04-recipe-page-homechef" --workspace dev-challenges/04-recipe-page-homechef
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/04-recipe-page-homechef
```
