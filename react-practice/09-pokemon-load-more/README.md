# 09 - Paginated Pokemons list with "Load more"

| | |
| --- | --- |
| Source | [React Practice](https://reactpractice.dev/start-here/) |
| Category | Data fetching |
| Calendar position | Day 15 |
| Challenge brief | https://reactpractice.dev/exercise/build-a-paginated-pokemons-list-with-a-load-more-button-starting-from-failing-unit-tests/ |
| Status | **Not Started** |
...
```bash
mv react-practice/09-pokemon-load-more/README.md /tmp/challenge-readme.md
rm -rf react-practice/09-pokemon-load-more

npm create vite@latest react-practice/09-pokemon-load-more -- --template react --no-immediate
mv /tmp/challenge-readme.md react-practice/09-pokemon-load-more/README.md

npm pkg set name="@react-challenges/09-pokemon-load-more" --workspace react-practice/09-pokemon-load-more
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/09-pokemon-load-more
```
