# 05 - Hacker News top articles

| | |
| --- | --- |
| Source | [React Practice](https://reactpractice.dev/start-here/) |
| Category | Data fetching |
| Calendar position | Day 5 |
| Challenge brief | https://reactpractice.dev/exercise/show-top-10-articles-from-hacker-news/ |
| Status | **Not Started** |
...
```bash
mv react-practice/05-hacker-news-top-articles/README.md /tmp/challenge-readme.md
rm -rf react-practice/05-hacker-news-top-articles

npm create vite@latest react-practice/05-hacker-news-top-articles -- --template react --no-immediate
mv /tmp/challenge-readme.md react-practice/05-hacker-news-top-articles/README.md

npm pkg set name="@react-challenges/05-hacker-news-top-articles" --workspace react-practice/05-hacker-news-top-articles
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/05-hacker-news-top-articles
```
