# 13 - GitHub issues filter component

| | |
| --- | --- |
| Source | [React Practice](https://reactpractice.dev/start-here/) |
| Category | Real-world |
| Calendar position | Days 24-26 |
| Challenge brief | https://reactpractice.dev/exercise/build-the-github-issue-filter-component/ |
| Status | **Not Started** |
...
```bash
mv react-practice/13-github-issues-filter/README.md /tmp/challenge-readme.md
rm -rf react-practice/13-github-issues-filter

npm create vite@latest react-practice/13-github-issues-filter -- --template react --no-immediate
mv /tmp/challenge-readme.md react-practice/13-github-issues-filter/README.md

npm pkg set name="@react-challenges/13-github-issues-filter" --workspace react-practice/13-github-issues-filter
npm install
npm install tailwindcss @tailwindcss/vite --save-dev --workspace @react-challenges/13-github-issues-filter
```
